...
class ModelLoader:
    ...
    def _validate_env(self):
        ...
        if missing:
            ...
            raise TripPlannerPortalException("Missing environment variables", sys)
    ...
    def load_embeddings(self):
        ...
        try:
            ...
            raise TripPlannerPortalException("Failed to load embedding model", sys)
    ...
    def load_llm(self):
        ...
        provider_key = os.getenv("LLM_PROVIDER", "openai")  # Default groq
